...
const CardShimmer = () => {
  return (
    <div className="basis-[250px] mob:basis-[150px] p-2.5 mb-2.5 shadow animate-pulse">
      <div className="h-[144px] w-[230px] bg-slate-200 mob:w-[130px] mob:h-[81px]"></div>
      <div className="w-3/5 mt-2.5 h-[15px]  bg-slate-200 "></div>
      <div className="w-4/5 mt-1 h-[15px]  bg-slate-200"></div>
      <div className="w-full mt-[18px] h-[15px]  bg-slate-200"></div>
    </div>
  );
}
      ...
      <div className="flex justify-center">
        <div className="mt-7 w-[848px]">
          ...
          <div className="menu-items-list  flex flex-col justify-evenly">
            { Array.from({length:1}).map( (element, index)  => 
...
const Shimmer = () => { 
  return (
    <div className="flex flex-wrap gap-5 justify-evenly">
      {Array.from({length:SHIMMER_CARD_COUNT}).map((element, index) => {
